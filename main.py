...
if user_id:
    ...
    st.markdown("\n")
    st.markdown("<h6 style='text-align: center;'>Please read instructions in the sidebar carefully and \n type in your participant ID first!</h6>", unsafe_allow_html=True)
